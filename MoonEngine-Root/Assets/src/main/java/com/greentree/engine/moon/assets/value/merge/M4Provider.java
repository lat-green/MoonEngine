...
public final class M4Provider<T1, T2, T3, T4> implements ValueProvider<Group4<T1, T2, T3, T4>> {
    ...
    public M4Provider(Value<T1> Value1, Value<T2> Value2, Value<T3> Value3, Value<T4> Value4) {
    ...
    public M4Provider(ValueProvider<T1> provider1, ValueProvider<T2> provider2, ValueProvider<T3> provider3,
                      ValueProvider<T4> provider4) {
    ...
    public int characteristics() {
        return CHARACTERISTICS | (provider1.characteristics() & provider2.characteristics() & provider3.characteristics() & provider4.characteristics());
    }
    ...
    @Override
    public ValueProvider<Group4<T1, T2, T3, T4>> copy() {
        return new M4Provider<>(provider1.copy(), provider2.copy(), provider3.copy(), provider4.copy());
    }
