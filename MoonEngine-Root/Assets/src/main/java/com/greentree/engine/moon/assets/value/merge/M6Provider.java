...
public final class M6Provider<T1, T2, T3, T4, T5, T6> implements ValueProvider<Group6<T1, T2, T3, T4, T5, T6>> {
    ...
    public int characteristics() {
        return CHARACTERISTICS | (provider1.characteristics() & provider2.characteristics() & provider3.characteristics()
                & provider4.characteristics() & provider5.characteristics() & provider6.characteristics());
    }
