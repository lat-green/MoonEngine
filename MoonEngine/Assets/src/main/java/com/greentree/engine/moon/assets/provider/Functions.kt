...
interface AssetFunction2<T1 : Any, T2 : Any, R : Any> : AssetFunction1<Group2<out T1, out T2>, R> {
	...
	override fun invoke(ctx: AssetContext, value: Group2<out T1, out T2>): R {
		return invoke(ctx, value.t1, value.t2)
	}

	fun invoke(ctx: AssetContext, value1: T1, value2: T2): R
}

interface AssetFunction3<T1 : Any, T2 : Any, T3 : Any, R : Any> : AssetFunction1<Group3<out T1, out T2, out T3>, R> {

	override fun invoke(ctx: AssetContext, value: Group3<out T1, out T2, out T3>): R {
		return invoke(ctx, value.t1, value.t2, value.t3)
	}

	fun invoke(ctx: AssetContext, value1: T1, value2: T2, value3: T3): R
}

interface AssetFunction4<T1 : Any, T2 : Any, T3 : Any, T4 : Any, R : Any> :
	AssetFunction1<Group4<out T1, out T2, out T3, out T4>, R> {

	override fun invoke(ctx: AssetContext, value: Group4<out T1, out T2, out T3, out T4>): R {
		return invoke(ctx, value.t1, value.t2, value.t3, value.t4)
	}

	fun invoke(ctx: AssetContext, value1: T1, value2: T2, value3: T3, value4: T4): R
}
...
interface AssetFunction5<T1 : Any, T2 : Any, T3 : Any, T4 : Any, T5 : Any, R : Any> :
	...
	fun invoke(ctx: AssetContext, value1: T1, value2: T2, value3: T3, value4: T4, value5: T5): R
}
...
interface AssetFunction6<T1 : Any, T2 : Any, T3 : Any, T4 : Any, T5 : Any, T6 : Any, R : Any> :
	...
	fun invoke(ctx: AssetContext, value1: T1, value2: T2, value3: T3, value4: T4, value5: T5, value6: T6): R
}