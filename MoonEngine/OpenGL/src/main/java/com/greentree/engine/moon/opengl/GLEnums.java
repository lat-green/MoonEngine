...
import com.greentree.common.graphics.sglfw.SGLFW.GLFWKey;
import com.greentree.common.graphics.sglfw.SGLFW.GLFWMouseButton;
...
public class GLEnums {
    ...
    public static ButtonAction get(com.greentree.common.graphics.sglfw.SGLFW.ButtonAction action) {
    ...
    public static Supplier<KeyMode[]> get(Supplier<com.greentree.common.graphics.sglfw.SGLFW.KeyMode[]> mods) {
        return () -> get(mods.get());
    }

    public static KeyMode[] get(com.greentree.common.graphics.sglfw.SGLFW.KeyMode[] mods) {
    ...
    public static KeyMode get(com.greentree.common.graphics.sglfw.SGLFW.KeyMode action) {
        return switch (action) {
